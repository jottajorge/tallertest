...
<div class="content-row">
  <h2 class="content-row-title">Minha conta</h2>
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <div class="content-row">
         <div class="panel-body">
            <form role="form" action="../usuario/editar" method="post">
              <div class="form-group">
                <label for="email">Email</label>
                <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="<?php print $email; ?>" required readonly="true">
              </div>
              <div class="form-group">
